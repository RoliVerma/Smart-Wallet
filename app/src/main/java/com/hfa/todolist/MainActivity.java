...
public class MainActivity extends AppCompatActivity {
    ...
    public static final int ADD_NOTE_REQUEST=1;//used to distinguish result is coming from which
    public static final int EDIT_NOTE_REQUEST=2;//activity in case there are intents coming from various activities
        ...
        //swipe to delete functionality
         new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.LEFT|
            ...
            public boolean onMove(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, @NonNull RecyclerView.ViewHolder target) {
                return false;
            }//we dont need this functionality hence 1st para of SimpleCallBack is 0

            @Override
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                noteViewModel.delete(adapter.getNoteAt(viewHolder.getAdapterPosition()));//delete the swiped note
